...
class ConditionalProbabilityTable:
    ...
    @classmethod
    def from_dict(cls, **kwargs: Any) -> 'ConditionalProbabilityTable':
        """Instantiate from dict generated by `to_dict()`."""
        cpd = cls()
        kwargs['array'] = pickle.loads(kwargs['array'])
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        kwargs['array'] = pickle.dumps(self.array)
        kwargs['parents'] = self.parents
        del kwargs['cumsum_array']
        return kwargs
...
class ConditionalProbabilityDistribution:
    ...
    @classmethod
    def from_dict(cls, **kwargs: Any) -> 'ConditionalProbabilityDistribution':
        """Instantiate from dict generated by `to_dict()`."""
        cpd = cls()
        kwargs['array'] = pickle.loads(kwargs['array'])
        kwargs['parents'] = kwargs['parents']

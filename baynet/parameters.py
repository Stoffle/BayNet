...
class ConditionalProbabilityTable:
    ...
    def __init__(self, node: igraph.Vertex) -> None:
        ...
        if any([pl == None for pl in parent_levels]):
    ...
    def rescale_probabilities(self):
        """Set any variables with no probabilities to be uniform, scale CPT rows to sum to 1, then compute cumulative sums to make sampling faster"""
